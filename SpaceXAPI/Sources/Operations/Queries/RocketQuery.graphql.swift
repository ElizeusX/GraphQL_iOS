...
public class RocketQuery: GraphQLQuery {
  public static let operationName: String = "RocketQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query RocketQuery { rockets { __typename id name height { __typename meters } mass { __typename kg } } }"#
    ))
